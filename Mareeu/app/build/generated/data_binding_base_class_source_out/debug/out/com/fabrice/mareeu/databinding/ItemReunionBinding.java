...
public final class ItemReunionBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ItemReunionBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemReunionBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_reunion, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemReunionBinding bind(@NonNull View rootView) {
